import random # Importe la librairie random pour proposer des évènements au hasard
import smtplib # Import la librairie smtplib pour gérer les emails
import string # Importe la librairie string qui va nous donner tous les caractères
from time import sleep # Importe la librairie time pour gérer le temps

# Importe checkInput et clearConsole des outils
from outils import *

# On crée la variable "bot" qui va se connecter aux serveurs Gmail
...
def generatePassword():
    # Initialisation d'une liste de tous les caractères 
...
def connexion(mdp):
    ...
    while True:
        ...
        # Si l'utilisateur appuie sur "R" (ou "r", grâce au .upper()),
        ...
        # et n'appuie pas sur "R", il perd une chance
        else:
            chances -= 1
